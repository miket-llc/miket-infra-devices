...
# ============================================================================
# Quick fix for MagicDNS on Count-Zero (macOS)
# ============================================================================
...
echo -e "${CYAN}🔧 MagicDNS Remediation Script for Count-Zero${NC}"
echo -e "${CYAN}==============================================${NC}\n"
...
if [ -z "$CURRENT_TAGS" ]; then
    # Fallback to default tags for count-zero
    CURRENT_TAGS="tag:workstation,tag:macos"
fi
...
echo -e "${CYAN}Flags: --accept-dns --ssh${NC}"
