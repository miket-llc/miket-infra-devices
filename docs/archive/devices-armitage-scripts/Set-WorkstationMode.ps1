<#
.SYNOPSIS
    Manages workstation modes for Armitage (gaming vs productivity)
.DESCRIPTION
...
# Main execution
Write-Host "`nSwitching Armitage to $Mode mode..." -ForegroundColor Cyan
...
Write-Host "Mode configuration saved to: $env:LOCALAPPDATA\ArmitageMode\current_mode.json"