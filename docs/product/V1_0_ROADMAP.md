...
- **Wave 2 (Remote access UX)**  
  - Actions: standardize NoMachine client configs; remove RDP/VNC fallback paths (retired by miket-infra 2025-11-22); update playbooks for LAN vs Tailscale transport selection.  
